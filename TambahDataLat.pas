...
a:Integer;
begin
  if (e1.Text='') or (e1.Text='00.00') or (e2.Text='') or (e2.Text='00.00')then
  begin
  ...
  if (Form8.qry1.Locate('hari',c1.Text,[])) and (Form8.qry1.Locate('jam_mulai',e1.Text,[])) then //VALIDASI MEMBANDINGKAN DATA INPUTAN DENGAN DATA DI TABLE
  begin
...
begin
  ...
  if (e1.Text= Form8.qry1.Fields[1].AsString) and (c1.Text= Form8.qry1.Fields[3].AsString)then   //perbandingan dari inputan = table
  begin
  ...
  begin
    ...
    begin
      SQL.Clear;
      SQL.Add('update jadwal_table set jam_mulai="'+e1.Text+'",jam_akhir="'+e1.Text+'" where No="'+updt+'"');
      ExecSQL;
      bersih; //procedure bersih
...
try
  ...
  e1.Text:=Form8.qry1.Fields[1].AsString;
  e2.Text:=Form8.qry1.Fields[2].AsString;
  c1.Text:=Form8.qry1.Fields[3].AsString;
  dtp1.Date:=Form8.qry1.Fields[4].AsDateTime;
  e3.Text:=Form8.qry1.Fields[5].AsString;
  e4.Text:=Form8.qry1.Fields[6].AsString;
  e5.Text:=Form8.qry1.Fields[7].AsString;
  e6.Text:=Form8.qry1.Fields[8].AsString;
